...
d_save_path = r"model\D_net_face.pth"
g_save_path = r"model\G_net_face.pth"
    ...
    for epoch in range(50):
        for x in train:
            ...
            if (iter_count % 100 == 0):
                ...
                save_image(fake_images,"./face_image/{}-fake_image.jpg".format(iter_count),nrow=10,normalize=True,scale_each=True)
                save_image(x,"./face_image/{}-real_image.jpg".format(iter_count),nrow=10,normalize=True,scale_each=True)
